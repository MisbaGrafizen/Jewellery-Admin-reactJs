...
import { Activity, DailyDropdown } from '../../../src/Component/Constant';
// import { ActivityData } from '../../../Data/DefaultDashboard';
import { ActivityData } from '../../Component/Data/DefaultDashboard';
// import DropdownCommon from '../../Common/Dropdown';
import DropdownCommon from '../../Component/Common/Dropdown';

const ActivityCard = () => {
  return (
    <Col xxl='4' xl='5' md='6' sm='7' className='notification  font-Poppins box-col-6'>
