...
import { WelcomeMessage, WelcomeToCuba, WhatsNew } from '../Constant/index';

// import CarToon from '../../../assets/images/dashboard/cartoon.svg';
import CarToon from '../../../src/assetsMain/images/dashboard/cartoon.svg';
const GreetingCard = () => {
  return (
    <Col className='col-xxl-4 col-sm-6 font-Poppins box-col-6'>
